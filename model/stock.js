...
stock.prototype.handleRoutes = function(router,connection,md5)
{
  router.post("/insertStok",function(req,res){
     ...
     connection.query(query1,function(err,temp)
     {
        ...
        {
            //query insert
            var query = "INSERT INTO `stock` (id,nama,jumlah,satuan,hargaTotal,reorder) VALUES (?,?,?,?,?,?)";
            var table = [id,nama,jumlah,satuan,hargaTotal,reorder];
...
router.post("/updateStock",function(req,res)
{
  ...
  var reorderBaru = req.body.reorderBaru;
...
router.get("/cekStok",function(req,res){
